...
Source0  : https://download.gnome.org/sources/gnome-autoar/0.4/gnome-autoar-0.4.1.tar.xz
...
%prep
%setup -q -n gnome-autoar-0.4.1
cd %{_builddir}/gnome-autoar-0.4.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635637585
...
cp %{_builddir}/gnome-autoar-0.4.1/COPYING %{buildroot}/usr/share/package-licenses/gnome-autoar/01a6b4bf79aca9b556822601186afab86e8c4fbf
...
/usr/lib64/libgnome-autoar-0.so.0.1.1
/usr/lib64/libgnome-autoar-gtk-0.so.0
/usr/lib64/libgnome-autoar-gtk-0.so.0.1.1
