...
Source0  : https://download.gnome.org/sources/gnome-autoar/0.3/gnome-autoar-0.3.0.tar.xz
...
%prep
%setup -q -n gnome-autoar-0.3.0
cd %{_builddir}/gnome-autoar-0.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1613154650
...
cp %{_builddir}/gnome-autoar-0.3.0/COPYING %{buildroot}/usr/share/package-licenses/gnome-autoar/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
