...
Source0  : https://download.gnome.org/sources/gnome-autoar/0.4/gnome-autoar-0.4.0.tar.xz
...
%prep
%setup -q -n gnome-autoar-0.4.0
cd %{_builddir}/gnome-autoar-0.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628604248
...
cp %{_builddir}/gnome-autoar-0.4.0/COPYING %{buildroot}/usr/share/package-licenses/gnome-autoar/01a6b4bf79aca9b556822601186afab86e8c4fbf
...
/usr/lib64/libgnome-autoar-0.so.0.1.0
/usr/lib64/libgnome-autoar-gtk-0.so.0
/usr/lib64/libgnome-autoar-gtk-0.so.0.1.0
